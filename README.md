...
🔗 Links
Model Code (Kaggle): best-model on Kaggle

Dataset (Kaggle): PTB-XL ECG dataset
...
🩺 Class Distribution
Class | Description | Count -- | -- | -- NORM | Normal ECG | 9,528 MI | Myocardial Infarction | 5,486 STTC | ST/T Change | 5,250 CD | Conduction Disturbance | 4,907 HYP | Hypertrophy | 2,655
...
Best Model – ECG Signal Classification 🔗 Links Model Code (Kaggle): [best-model on Kaggle](https://www.kaggle.com/code/hagerabdelkaderr/best-model/edit)
Dataset (Kaggle): PTB-XL ECG dataset
...
Model Architecture (Hybrid CNN + Dense)
